...
//		Crunch skill = new Crunch("Driving", 20);
//		Crunch attribute = new Crunch("STR");
//		
//		System.out.println("Skill: " + skill.getValueFormatted());
//		System.out.println("Skill (Half): " + skill.getHalfValueFormatted());
//		System.out.println("Skill (Fifth): " + skill.getFifthValueFormatted());
//		System.out.println("Attribute: " + attribute.getValue());
//		System.out.println("Attribute (Half): " + attribute.getHalfValue());
//		System.out.println("Attribute (Fifth): " + attribute.getFifthValue());
//		
//		attribute.assignValue(70, true);
//		
//		System.out.println("Skill: " + skill.getValueFormatted());
//		System.out.println("Skill (Half): " + skill.getHalfValueFormatted());
//		System.out.println("Skill (Fifth): " + skill.getFifthValueFormatted());
